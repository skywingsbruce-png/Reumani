...
SYNTHESIS_CONTRACT = OutputContract(
    ...
    fields=[
        ...
        FL(name="contradictions", type="string_list", max_items=2, max_characters=140,
           scientific=True, semantic_note="evidence that conflicts with the claim"),
        FL(name="evidence_gaps", type="string_list", max_items=2, max_characters=140,
           scientific=True, semantic_note="what the provided evidence cannot answer"),
        FL(name="causal_assessment", type="enum", enum_values=list(ALLOWED_CAUSAL_LABELS),
           free_text_allowed=False, scientific=True,
           semantic_note="must NOT exceed the causal ceiling given above; "
                         "associative evidence must never be reported as direct causation"),
        FL(name="limitations", type="string_list", max_items=3, max_characters=140,
           scientific=True, semantic_note="scope limits that prevent extrapolation"),
        FL(name="citations", type="string_list", max_items=6, max_characters=32,
           evidence_reference_only=True, free_text_allowed=False, scientific=True,
           semantic_note="only evidence_ids listed above; never invent identifiers"),
    ])
...
VERIFIER_CONTRACT = OutputContract(
    ...
    fields=[
        FL(name="verdict", type="enum", enum_values=list(VERDICTS), free_text_allowed=False,
           scientific=True,
           semantic_note="decide ONLY from the EvidenceCards provided; when the evidence is "
                         "insufficient you may and should return insufficient_evidence"),
        FL(name="reason", type="string", max_characters=260, scientific=True,
           semantic_note="cite which provided evidence drove the verdict"),
        FL(name="fact_conflicts", type="string_list", max_items=2, max_characters=140,
           scientific=True, semantic_note="claims contradicting the authoritative facts"),
        FL(name="citation_conflicts", type="string_list", max_items=2, max_characters=140,
           scientific=True, semantic_note="citations that do not support what they are cited for"),
        FL(name="causal_overstatement", type="bool", free_text_allowed=False, scientific=True,
           semantic_note="true if the synthesis claims more causality than the evidence allows"),
        FL(name="unsupported_claims", type="string_list", max_items=3, max_characters=140,
           scientific=True, semantic_note="statements not backed by the provided evidence"),
        FL(name="required_corrections", type="string_list", max_items=3, max_characters=140,
           scientific=True, semantic_note="what must change before this could be accepted"),
        FL(name="human_review", type="bool", free_text_allowed=False, scientific=True,
           semantic_note="true if a human must review before any artifact is trusted"),
    ])
