...
AUTOANTIBODIES = {
    ...
    "anti-Mi2": {"aka": ["Mi-2", "CHD4"], "disease": "皮肌炎DM", "subtype": "经典DM",
                 "clinical": "典型皮疹(向阳疹/Gottron)、激素反应好、预后佳、肿瘤风险低", "assay": "免疫印迹/ELISA"},
    "anti-NXP2": {"aka": ["MJ", "NXP-2"], "disease": "皮肌炎DM", "subtype": "幼年/成人",
                  "clinical": "钙质沉着(幼年)、成人肿瘤关联、水肿性肌炎", "assay": "免疫印迹"},
    "anti-SRP": {"aka": ["signal recognition particle"], "disease": "免疫介导坏死性肌病IMNM",
                 "subtype": "坏死性肌病", "clinical": "重度对称近端无力、CK极高、心脏受累、治疗抵抗", "assay": "免疫印迹/ELISA"},
    "anti-HMGCR": {"aka": ["HMG-CoA还原酶", "200/100"], "disease": "免疫介导坏死性肌病IMNM",
                   "subtype": "他汀相关/非相关", "clinical": "他汀暴露后坏死性肌病(停药不缓解)、CK高", "assay": "ELISA"},
    "anti-SAE": {"aka": ["SAE1"], "disease": "皮肌炎DM", "subtype": "成人",
                 "clinical": "皮肤起病后进展为肌炎、吞咽困难", "assay": "免疫印迹"},
    "anti-PL7/PL12": {"aka": ["threonyl/alanyl-tRNA", "非Jo1抗合成酶"], "disease": "肌炎IIM",
                      "subtype": "抗合成酶综合征", "clinical": "ILD为主(可无明显肌炎)、机械手", "assay": "免疫印迹"},
    "anti-ribosomal-P": {"aka": ["核糖体P蛋白", "anti-P"], "disease": "SLE", "subtype": "神经精神狼疮NPSLE",
                         "clinical": "神经精神狼疮、狼疮肝炎、活动度相关；较特异", "assay": "ELISA/免疫印迹"},
    # ---- ANCA相关血管炎 AAV ----
...
FLOW_SUBSETS = {
    ...
    "浆样树突细胞 pDC": {"markers": ["Lin-", "HLA-DR+", "CD123+", "CD303/BDCA2+", "CD304/BDCA4+"],
                    "relevance": "I型干扰素主要来源；SLE/SSc/皮肌炎 IFN 通路核心"},
    "细胞毒CD8 T": {"markers": ["CD3+", "CD8+", "granzyme B+", "perforin+", "CD57+/CD28-"],
                 "relevance": "肌炎肌肉浸润/血管炎内皮损伤；细胞毒效应"},
    "调节性B细胞 Breg": {"markers": ["CD19+", "CD24hi", "CD38hi(过渡型)", "IL-10+(刺激后)"],
                    "relevance": "免疫抑制；SLE/SSc/RA 中数量或功能受损"},
    "γδ T细胞": {"markers": ["CD3+", "TCRγδ+", "Vδ1/Vδ2"],
               "relevance": "黏膜/固有样免疫；部分风湿病及血管炎中改变"},
    "MAIT细胞": {"markers": ["CD3+", "CD161hi", "TCR Vα7.2+", "CD8+/DN"],
              "relevance": "黏膜相关恒定T；SLE/RA 外周减少、组织富集"},
}
